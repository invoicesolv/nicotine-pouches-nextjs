...
import { generateContactPageMeta, pageMetaToMetadata } from '@/lib/meta-generator';
              ...
              <div className="fusion-column-wrapper">
                <div className="fusion-title title fusion-title-2 fusion-sep-none fusion-title-text fusion-title-size-two" 
                  ...
                  <h2 className="fusion-title-heading title-heading-left" style={{ margin: '0', fontSize: '1em' }}>
                    Contact Nicotine Pouches Comparison
                  </h2>
                </div>
                
                <div className="fusion-text fusion-text-1" style={{ color: '#333', lineHeight: '1.6', fontSize: '16px', marginBottom: '30px' }}>
                  <p>We'd love to hear from you! Whether you have questions about our platform, suggestions for improvement, or need assistance with your nicotine pouch research, our team is here to help.</p>
                  
                  <p>At Nicotine Pouches Comparison, we value your feedback and are committed to providing excellent customer service. Our knowledgeable team is ready to assist you with any inquiries you may have.</p>
                ...
                <div className="fusion-text fusion-text-2" style={{ color: '#333', lineHeight: '1.6', fontSize: '16px', marginBottom: '30px' }}>
                  <ul style={{ paddingLeft: '20px', margin: '0' }}>
                    <li style={{ marginBottom: '15px' }}>
                      <strong>Email Support:</strong> Contact us via email for detailed inquiries and support.
                    </li>
                    <li style={{ marginBottom: '15px' }}>
                      <strong>Quick Response:</strong> We typically respond to all inquiries within 24 hours.
                    </li>
                    <li style={{ marginBottom: '15px' }}>
                      <strong>Expert Advice:</strong> Our team includes nicotine pouch experts ready to help.
                    </li>
                  </ul>
                </div>

                <div className="fusion-text fusion-text-3" style={{ color: '#333', lineHeight: '1.6', fontSize: '16px', marginBottom: '30px' }}>
                  <p>Your satisfaction is our priority. We're committed to providing you with the best possible experience on our platform and ensuring that all your questions are answered thoroughly.</p>
                  
                  <p>Don't hesitate to contact us if you need any assistance or have suggestions for how we can improve our service.</p>
                </div>

                <div className="fusion-text fusion-text-4" style={{ color: '#333', lineHeight: '1.6', fontSize: '16px' }}>
                  <p>We believe that open communication is key to building a strong community of nicotine pouch enthusiasts. Whether you're a first-time visitor or a long-time user, we want to make sure you have the best possible experience on our platform.</p>
                  
                  <p>Thank you for choosing Nicotine Pouches Comparison as your trusted resource for nicotine pouch information and comparisons.</p>
                </div>
              </div>
            </div>
          </div>
...
export async function generateMetadata(): Promise<Metadata> {
  const metaData = pageMetaToMetadata(generateContactPageMeta());
  return metaData;
}

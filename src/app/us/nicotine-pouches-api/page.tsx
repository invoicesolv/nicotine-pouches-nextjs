    ...
    <>
      <style jsx>{`
        @media (max-width: 768px) {
          ...
          .us-api-sidebar ul li {
            margin-bottom: 10px !important;
          }
          .us-api-sidebar ul li a {
      ...
      <div id="wrapper" className="fusion-wrapper">
        ...
        <div className="fusion-fullwidth fullwidth-box fusion-builder-row-1 fusion-flex-container has-pattern-background has-mask-background hundred-percent-fullwidth non-hundred-percent-height-scrolling" 
          ...
          <div className="us-api-container fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap" 
               style={{
                 width: '100%',
                 maxWidth: '1200px',
                 margin: '0 auto',
            ...
            {/* Sidebar */}
            <div className="us-api-sidebar fusion-layout-column fusion_builder_column fusion_builder_column_1_4 1_4 fusion-flex-column" 
            ...
            {/* Main Content */}
            <div className="us-api-content fusion-layout-column fusion_builder_column fusion_builder_column_3_4 3_4 fusion-flex-column" 
                 style={{ width: '75%' }}>
              <div className="fusion-column-wrapper">

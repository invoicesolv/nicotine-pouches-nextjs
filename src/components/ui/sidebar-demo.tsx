...
import { LayoutDashboard, Heart, Bell, Settings, LogOut, Package } from "lucide-react";
...
export function SidebarDemo() {
  ...
  const links = [
    ...
    },
    {
      ...
      icon: (
        <Bell className="text-neutral-700 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Products",
      href: "/",
      icon: (
        <Package className="text-neutral-700 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Settings",
...
// Dashboard component with your existing content
const Dashboard = () => {
  return (
